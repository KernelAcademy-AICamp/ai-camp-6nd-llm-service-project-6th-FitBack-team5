...
- 응원·활용도 프레이밍을 쓴다. 예: "한 번 더 가면 회당 비용이 내려가요", "지금 가면 이번 달 ROI가 올라가요".
...
- headline에 "파이팅" "화이팅" "오늘도" "힘내세요" 같은 빈 응원 문구 금지.
  반드시 데이터(방문 횟수·페이스·ROI)에서 뽑은 구체적인 한마디여야 한다.
  나쁜 예) "오늘도 파이팅!" → 좋은 예) "이번 주 목표까지 1회 남았어요"
